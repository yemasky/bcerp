...
<html lang="cn">
    <head>
        ...
        <link href="${__RESOURCE}assets/plugins/metisMenu/metisMenu.min.css" rel="stylesheet">
        <link href="${__RESOURCE}assets/plugins/fontawesome/css/all.min.css" rel="stylesheet">
        <link href="${__RESOURCE}assets/plugins/typicons/src/typicons.min.css" rel="stylesheet">
        <link href="${__RESOURCE}assets/plugins/themify-icons/themify-icons.min.css" rel="stylesheet">
        <!--Third party Styles(used by this page)--> 
        <link href="${__RESOURCE}assets/plugins/datatables/dataTables.bootstrap4.min.css" rel="stylesheet">
    ...
    <body class="fixed">
        ...
        <div class="wrapper">
            ...
            <nav class="sidebar sidebar-bunker">
                <div class="sidebar-header">
                    ...
                    <a href="index.html" class="logo"><img src="${__RESOURCE}assets/dist/img/logo.png" alt=""></a>
                </div><!--/.sidebar header-->
                <div class="profile-element d-flex align-items-center flex-shrink-0">
                    <div class="avatar online">
                        <img src="${__RESOURCE}assets/dist/img/avatar-1.jpg" class="img-fluid rounded-circle" alt="">
                    </div>
                    <div class="profile-text">
                        <h6 class="m-0">Naeem Khan</h6>
                        <span><a href="https://bhulua.thememinister.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="56332e373b263a3316313b373f3a7835393b">[email&#160;protected]</a></span>
                    </div>
                </div><!--/.profile element-->
                ...
                <div class="sidebar-body">
                    <nav class="sidebar-nav">
                        <ul class="metismenu">
                            ...
                            <li class="mm-active">
                                <a class="has-arrow material-ripple" href="index.html#">
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level">
                                    ...
                                    <li>
                                        <a class="has-arrow" href="index.html#" aria-expanded="false">Data tables</a>
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level">
                                    ...
                                    <li>
                                        <a class="has-arrow" href="index.html#" aria-expanded="false">Level - 2</a>
                                        <ul class="nav-third-level">
                                            <li><a href="index.html#">Menu Item</a></li>
                                            <li>
                                                <a class="has-arrow" href="index.html#" aria-expanded="false">Level - 3</a>
                                                <ul class="nav-fourth-level">
                                                    <li><a href="index.html#">Level - 4</a></li>
                                                </ul>
                                            </li>
                                        </ul>
                                    </li>
                            ...
                            <li><a href="index.html#"><i class="typcn typcn-support mr-2"></i>Documentation</a></li>
                        </ul>
                    </nav>
                </div><!-- sidebar-body -->
            </nav>
            ...
            <div class="content-wrapper">
                        ...
                        <div class="d-flex flex-grow-1">
                            <ul class="navbar-nav flex-row align-items-center ml-auto">
                                ...
                                <li class="nav-item dropdown notification">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <div class="notification-list">
                                            <div class="media new">
                                                <div class="img-user"><img src="${__RESOURCE}assets/dist/img/avatar.png" alt=""></div>
                                            ...
                                            <div class="media new">
                                                <div class="img-user online"><img src="${__RESOURCE}assets/dist/img/avatar2.png" alt=""></div>
                                                <div class="media-body">
                                            ...
                                            <div class="media">
                                                <div class="img-user"><img src="${__RESOURCE}assets/dist/img/avatar3.png" alt=""></div>
                                                <div class="media-body">
                                            ...
                                            <div class="media">
                                                <div class="img-user"><img src="${__RESOURCE}assets/dist/img/avatar4.png" alt=""></div>
                                                <div class="media-body">
                                ...
                                <li class="nav-item dropdown user-menu">
                                    <a class="nav-link dropdown-toggle" href="index.html#" data-toggle="dropdown">
                                        <!--<img src="${__RESOURCE}assets/dist/img/user2-160x160.png" alt="">-->
                                        <i class="typcn typcn-user-add-outline"></i>
                                    </a>
                                    <div class="dropdown-menu dropdown-menu-right" >
                                        <div class="dropdown-header d-sm-none">
                                            <a href="index.html" class="header-arrow"><i class="icon ion-md-arrow-back"></i></a>
                                        </div>
                                        <div class="user-header">
                                            <div class="img-user">
                                                <img src="${__RESOURCE}assets/dist/img/avatar-1.jpg" alt="">
                                            </div><!-- img-user -->
                                            <h6>Naeem Khan</h6>
                                            <span><a href="https://bhulua.thememinister.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="debba6bfb3aeb2bb9eb9b3bfb7b2f0bdb1b3">[email&#160;protected]</a></span>
                                        </div><!-- user-header -->
                                        ...
                                        <a href="index.html" class="dropdown-item"><i class="typcn typcn-arrow-shuffle"></i> Activity Logs</a>
                                        <a href="index.html" class="dropdown-item"><i class="typcn typcn-cog-outline"></i> Account Settings</a>
                                        <a href="https://bhulua.thememinister.com/page-signin.html" class="dropdown-item"><i class="typcn typcn-key-outline"></i> Sign Out</a>
                                    </div><!--/.dropdown-menu -->
                                </li>
                            </ul><!--/.navbar nav-->
                            <div class="nav-clock">
                                    ...
                                    <div class="card-body text-center">
                                        <div class="row justify-content-center">
                                            <div class="greet-user col-12 col-xl-10">
                                                <img src="${__RESOURCE}assets/dist/img/happiness.svg" alt="..." class="img-fluid  mb-2">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-lg-6">
                                        ...
                                        <div class="d-flex position-relative overflow-hidden flex-column p-3 mb-3 bg-white shadow-sm rounded">
                                            ...
                                            <div class="d-flex">
                                                <div>
                                                    <img class="d-block rounded-circle" width="32" src="${__RESOURCE}assets/dist/img/avatar-5.jpg">
                                                </div>
                                                <div class="pl-3">
                                                    Nothing bad to say<br/> at this point 😌
                                                    <a class="d-block mt-1 small opacity-75" href="https://bhulua.thememinister.com/cdn-cgi/l/email-protection#bfd7dacdd2ded1cccbdecdd6d4d0c9ffd8d2ded6d391dcd0d2">Write back</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <table class="table display table-bordered table-striped table-hover bg-white m-0 card-table">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <div class="avatar-group">
                                                                <a href="user_profile.html" class="avatar avatar-xs" data-toggle="tooltip" title="Melissa Ayre">
                                                                    <img src="${__RESOURCE}assets/dist/img/avatar-1.jpg" class="avatar-img rounded-circle" alt="...">
                                                                </a>
                                                                <a href="user_profile.html" class="avatar avatar-xs" data-toggle="tooltip" title="Karen Robinson">
                                                                    <img src="${__RESOURCE}assets/dist/img/avatar-2.jpg" class="avatar-img rounded-circle" alt="...">
                                                                </a>
                                                                <a href="user_profile.html" class="avatar avatar-xs" data-toggle="tooltip" title="Miyah Myles">
                                                                    <img src="${__RESOURCE}assets/dist/img/avatar-3.jpg" class="avatar-img rounded-circle" alt="...">
                                                                </a>
                                                                <a href="user_profile.html" class="avatar avatar-xs" data-toggle="tooltip" title="Daniela Dewitt">
                                                                    <img src="${__RESOURCE}assets/dist/img/avatar-4.jpg" class="avatar-img rounded-circle" alt="...">
                                                                </a>
                                                            </div>
                                                        </td>
                                                        <td>Naeem Khan</td>
                                                        ...
                                                        <td>Noakhali</td>
                                                        <td>
                                                            <a href="index.html#" class="btn btn-success-soft btn-sm mr-1"><i class="far fa-eye"></i></a>
                                                            <a href="index.html#" class="btn btn-danger-soft btn-sm"><i class="far fa-trash-alt"></i></a>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="avatar-group">
                                                                ...
                                                                <a href="user_profile.html" class="avatar avatar-xs" data-toggle="tooltip" title="Daniela Dewitt">
                                                                    <img src="${__RESOURCE}assets/dist/img/avatar-5.jpg" class="avatar-img rounded-circle" alt="...">
                                                                </a>
                                                            </div>
                                                        </td>
                ...
                <footer class="footer-content">
                    <div class="footer-text d-flex align-items-center justify-content-between">
                        ...
                        <div class="credit">Designed by: <a href="index.html#">Bdtask</a></div>
                    </div>
        ...
        <%-- <script data-cfasync="false" src="https://bhulua.thememinister.com/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script>
        <script src="${__RESOURCE}assets/plugins/jQuery/jquery-3.4.1.min.js"></script>
        <script src="${__RESOURCE}assets/dist/js/popper.min.js"></script>
        <script src="${__RESOURCE}assets/plugins/bootstrap/js/bootstrap.min.js"></script>
        <script src="${__RESOURCE}assets/plugins/metisMenu/metisMenu.min.js"></script>
        <script src="${__RESOURCE}assets/plugins/perfect-scrollbar/dist/perfect-scrollbar.min.js"></script>
        <!-- Third Party Scripts(used by this page)-->
        <script src="${__RESOURCE}assets/plugins/chartJs/Chart.min.js"></script>
        <script src="${__RESOURCE}assets/plugins/sparkline/sparkline.min.js"></script>
        <script src="${__RESOURCE}assets/plugins/datatables/dataTables.min.js"></script>
        <script src="${__RESOURCE}assets/plugins/datatables/dataTables.bootstrap4.min.js"></script>
        <!--Page Active Scripts(used by this page)-->
        <script src="${__RESOURCE}assets/dist/js/pages/dashboard.js"></script>
        <!--Page Scripts(used by all page)-->
        <script src="${__RESOURCE}assets/dist/js/sidebar.js"></script> --%>
    </body>
</html>