...
public class ReadProperties {
	...
	public String read(String key) {
		System.out.println("ReadProperties read:"+key);
	...
	public void readToProperties(String propertiesFile) throws IOException {
		...
		if (os.contains("Windows")) {
		    // 当前系统是Windows
			inputStream = this.getClass().getClassLoader().getResourceAsStream("config/"+propertiesFile);
		} else {
			inputStream = this.getClass().getClassLoader().getResourceAsStream("config/linux_"+propertiesFile);
		}
