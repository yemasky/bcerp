...
public class Company {
	...
	public String getCompany_enaddress() {
		return company_enaddress;
	}
	public void setCompany_enaddress(String company_enaddress) {
		this.company_enaddress = company_enaddress;
	}
	...
	public String getCompany_credit_code() {
		return company_credit_code;
	}
	public void setCompany_credit_code(String company_credit_code) {
		this.company_credit_code = company_credit_code;
	}
	public String getCompany_reg_capital() {
		return company_reg_capital;
	}
	public void setCompany_reg_capital(String company_reg_capital) {
		this.company_reg_capital = company_reg_capital;
	}
	public String getCompany_reg_date() {
		return company_reg_date;
	}
	...
	public void setCompany_permit_number(String company_permit_number) {
		this.company_permit_number = company_permit_number;
	}
	public String getCompany_inspection_number() {
		return company_inspection_number;
	}
	public void setCompany_inspection_number(String company_inspection_number) {
		this.company_inspection_number = company_inspection_number;
	}
	public String getCompany_certificate_number() {
		return company_certificate_number;
	}
	...
	public String getCompany_trade_code() {
		return company_trade_code;
	}
	public void setCompany_trade_code(String company_trade_code) {
		this.company_trade_code = company_trade_code;
	}
